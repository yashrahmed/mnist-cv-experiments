...
from common.img_utils import show_images, draw_brief_features_on_image, to_color
...
def visualize_brief_experiment():
    ...
    img_with_briefs = [cv2.resize(draw_brief_features_on_image(to_color(image), brief_coords), (200, 200)) for image in
                       train_images[idxs]]
