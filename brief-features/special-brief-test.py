...
from common.img_utils import draw_brief_features_on_image, show_images, to_color
...
if __name__ == '__main__':
    ...
    out_image = cv2.resize(draw_brief_features_on_image(to_color(train_image[0]), loc_pairs, resize_value=(28, 28)), (200, 200))
